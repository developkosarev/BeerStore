    ...
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordRequiresDigit()
        {
            return new IdentityError
            {
                ...
                Description = _localizer["PasswordRequiresDigit"].Value //Description = "Passwords must have at least one digit ('0'-'9')." //_localizer["UserExist"].Value
        };
        }
        ...
        public override IdentityError PasswordRequiresLower()
        {
            return new IdentityError
            {
                ...
                Description = _localizer["PasswordRequiresLower"].Value //Description = "Passwords must have at least one lowercase ('a'-'z')."
            };
        }
        ...
        public override IdentityError PasswordRequiresUpper()
        {
            return new IdentityError
            {
                ...
                Description = _localizer["PasswordRequiresUpper"].Value //Description = "Passwords must have at least one uppercase ('A'-'Z')."
            };
        }
